                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                    {categories.map((category) => (
                        <button
                            ...
                            className="group relative flex flex-col items-center text-center p-8 rounded-2xl bg-slate-800/30 border border-white/5 hover:border-white/10 hover:bg-slate-800/50 transition-all duration-300 hover:-translate-y-1"
                        >
                            {/* Hover Glow */}
                            ...
                            {/* Icon */}
                            <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${category.color} p-4 mb-6 shadow-lg transform group-hover:scale-110 transition-transform duration-300 relative z-10 flex items-center justify-center`}>
...
const HeaderTitle = () => (
    <div className="relative flex flex-col items-center animate-fade-in-up">
        <h2 className="text-5xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-yellow-400 to-amber-600 drop-shadow-sm tracking-tighter mb-2 relative z-10">
            ICPC MINYA
        </h2>
        <h2 className="text-3xl md:text-6xl font-extrabold tracking-tight drop-shadow-[0_0_30px_rgba(59,130,246,0.3)] relative z-10">
